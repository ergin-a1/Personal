...
#       end
    ...
    get_campaigns: {
      ...
      input_fields: lambda do |object_definitions|
        [
          { name: "from_timestamp", label: "From timestamp", hint: "Epoch time from when campaigns need to be fetched"},
          { name: "to_timestamp", label: "To timestamp", hint: "Epoch time till when campaigns need to be fetched"}
        ]
      end,
      ...
      execute: lambda do |connection, input|
        ...
        pageNumber = 0
        count = 100
        puts "This information is logged from custom connector."
